...
describe('DurableContext', () => {
    ...
    beforeEach(() => {
        jest.clearAllMocks();
        ctx = new context_1.DurableContext();
    });
    ...
    test('long sleep (>= 30s) schedules task and throws interrupt', async () => {
        ...
        ctx = new context_1.DurableContext(undefined, event);
        await expect(ctx.sleep(60)).rejects.toThrow(context_1.DurableSleepInterrupt);
